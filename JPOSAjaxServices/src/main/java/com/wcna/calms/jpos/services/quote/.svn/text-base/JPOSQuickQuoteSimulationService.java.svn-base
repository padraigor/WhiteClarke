...
public class JPOSQuickQuoteSimulationService extends CalmsAjaxService {
	...
	public JPOSQuickQuoteSimulationService(IJPOSQuickQuoteService jposQuickQuoteService, IFormatService formatService, ICustomerService customerService,
