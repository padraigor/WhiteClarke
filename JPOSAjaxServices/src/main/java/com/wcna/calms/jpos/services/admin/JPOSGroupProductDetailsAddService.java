...
public class JPOSGroupProductDetailsAddService extends CalmsAjaxService {

	private IJPOSAdminProductService service = null;
	private final BeanConverterUtil beanUtil;
	public JPOSGroupProductDetailsAddService(IJPOSAdminProductService service) {
	...
	public Object invoke(Object object) {
		...
		if (object != null && object instanceof Map) {
			...
			service.addGroupProduct (setting);
