...
public class JPOSDealerProductDetailsAddService extends CalmsAjaxService {

	private IJPOSAdminProductService service = null;
	private final BeanConverterUtil beanUtil;
	public JPOSDealerProductDetailsAddService(IJPOSAdminProductService service) {
	...
	public Object invoke(Object object) {
		...
		if (object != null && object instanceof Map) {
			...
			service.addDealerProduct (setting);
