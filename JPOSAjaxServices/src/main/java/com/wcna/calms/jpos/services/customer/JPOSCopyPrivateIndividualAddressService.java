...
public class JPOSCopyPrivateIndividualAddressService extends
		MainApplicantLoadService {
	...
	public JPOSCopyPrivateIndividualAddressService(
	...
	public Object invoke(Object object) {
		...
		if (object instanceof Map) {
			...
			String phoneTypes = (String) super.projectProperties
					.get(IClientConstants.COPY_PHONE_DETAILS_FROM_PI_MAIN_APP);
