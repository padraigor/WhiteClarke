...
import com.wcg.calms.service.customer.ConsumerCustomerSave;
...
public class JPOSConsumerCustomerSave extends ConsumerCustomerSave implements IBusinessRuleValidationService{
	...
	public boolean validate(Map objectMap){
		if (preSaveService != null){
			...
			objectMap.put(IGenericScreenConstants.APP_CUSTOMER_ROLE_CODE, getCustomerRoleCode());
			objectMap.put(IGenericScreenConstants.APP_CUSTOMER_REF2_TYPE_CODE, getRef2TypeCode());
