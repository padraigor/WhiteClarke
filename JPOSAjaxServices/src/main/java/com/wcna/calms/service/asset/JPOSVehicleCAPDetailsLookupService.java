...
public class JPOSVehicleCAPDetailsLookupService extends CalmsAjaxService implements IBusinessRuleValidationService{
	...
	public JPOSVehicleCAPDetailsLookupService(IJPOSVehicleCAPDetailsService vehCAPDetailsService,
	...
	public Object invoke(Object object) {
		...
		if (object != null && object instanceof Map) {
			...
			dataMap=  this.vehCAPDetailsService.lookup(vehicleCAPDetailsMap);
		//	if(!result){
	...
	public boolean validate(Map objectMap){
		if (preSaveService != null){
			...
			objectMap.put(IGenericScreenConstants.VALIDATION_EVENT_SOURCE, "LOOKUP");
